...
class MakeAClusterWidget(QWidget):
    ...
    def create_cluster(self):
        ...
        #print(self.particles.mass.sum().value_in(units.MSun))
        self.widget.actionSave.setEnabled(True)
        #self.widget.actionLoad.setEnabled(True)
    ...
    def plot_cluster(self):
        ...
        #s = self.particles.mass.value_in(units.MSun)**(3.8/2.)
    ...
    def save_file(self):
        ...
        write_set_to_file(particles,clusterfile,"amuse")
